...
var (
	client     dynamicasset.UserDynamicAssetServiceClient
...
func initClient() {
	...
	client = dynamicasset.NewUserDynamicAssetServiceClient(grpcClient.Conn)
}

func Client() dynamicasset.UserDynamicAssetServiceClient {
	if client == nil {
		initClient()
	}
	return client
